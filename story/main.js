  ...
  try {
    for (var batch = 0; batch < totalBatches; batch++) {
      ...
      var prompt = prevSummary + '你是一個專業的社群媒體故事創作者。' + (isFirst ? '請根據以下設定創作一個分篇章的故事。' : '請接續前面的劇情繼續寫。') + '\n\n' +
        ...
        '【語言】繁體中文\n\n' +
        '【創作指導 — 絕對禁止出現在故事中】\n' +
        '⚠️ 規則用語只是指導，禁止寫進故事。角色矛盾透過行為展現，用具體動作描寫人物。\n' +
        '❌ 禁止：自我矛盾、付出代價、感情轉折、累積、終於等指令用語\n' +
        '❌ 禁止結尾變 TED 演講（如「你呢？你的XX是什麼？」「你準備好了嗎？」）\n' +
        '❌ 成功不能來太快太順 — 失敗要更具體更難看，成功前多待一篇讓掙扎更真實\n' +
        '❌ 禁止好萊塢式爆紅（KOL轉發→爆紅→出版社找上門這種太順的路線）\n' +
        '✅ 不同類型用不同標準：小說要人物弧線，勵志文要代入感和可信度，科普要邏輯嚴謹\n' +
        '✅ 具體細節建立可信度（金額、場景、自嘲），可信度要維持到最後一篇\n\n' +
