...
async function generate() {
  ...
  var prompt = '你是一個專業的社群媒體故事創作者。請根據以下設定創作一個分篇章的故事。\n\n' +
    ...
    '【語言】繁體中文\n\n' +
    '【寫作品質要求 — 嚴格遵守】\n' +
    '核心原則：角色驅動，不是情節驅動。每一個劇情發展必須從角色的內在邏輯出發。\n\n' +
    '1. 人物設計：寫每個主要角色前，先想清楚：他最害怕失去什麼？最大的自我矛盾是什麼？故事結束時內心改變了什麼？\n' +
    '2. 衝突必須有成本：主角必須付出真實代價（失去在乎的東西、做出掙扎的選擇、暴露弱點）。禁止衝突被輕鬆解決、主角零損失。\n' +
    '3. 伏筆規則：埋謎題前先寫好謎底，謎底必須邏輯一致，讓讀者回頭看覺得「原來如此」。禁止用巧合或硬解釋收伏筆。\n' +
    '4. 感情轉折必須有累積：告白或關鍵場景前要有足夠細節鋪墊，讀者要覺得「終於！」而不是「怎麼突然就好了？」\n' +
    '5. 具體場景優先於標籤：不要寫「他眼神冷漠氣場強大」，要寫「他沒有抬頭，只是繼續翻手上的文件，像是她根本不存在」。用行為和細節展現人物。\n' +
    '6. 每篇檢查：主角內心狀態有改變嗎？衝突中主角有主動做決定嗎？有沒有「因為劇情需要」而非「角色會這樣做」的情節？讀者會記住哪個具體瞬間？\n\n' +
